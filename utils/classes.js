...
const BASE_CLASSES = {
    cavalheiro_eter: {
        ...
        rarity: 'comum',
        rarityName: 'Comum',
        desc: 'Guerreiro equilibrado do Éter. Bom em combate corpo a corpo e resistência.',
        activeAbilities: ['Golpe de Espada', 'Postura de Ferro', 'Investida', 'Grito de Guerra'],
        passives: ['Vitalidade', 'Treino Constante'],
        powers: ['Golpe de Espada', 'Postura de Ferro', 'Investida', 'Grito de Guerra'],
        disadvantages: ['Pouca magia'],
        bonus: { forca: 2, defesa: 1, agilidade: 0, vida: 2 },
        manaMult: 1,
        color: 0x94a3b8,
        basicAttack: { id: 'golpe_espada', name: 'Golpe de Espada', emoji: '⚔️', type: 'physical', power: 1.1, mana: 0 },
        classGear: { arma: 'espada_aco', armadura: null, acessorio: 'cinto_forca' }
    },
    bruxo_ruinas: {
        id: 'bruxo_ruinas',
        ...
        rarity: 'comum',
        rarityName: 'Comum',
        desc: 'Mago que canaliza o poder das ruínas antigas. Alto dano mágico.',
        activeAbilities: ['Raio Arcano', 'Explosão de Ruína', 'Barreira Mística', 'Dreno de Mana'],
        passives: ['Afinidade Arcana', 'Mente Focada'],
        powers: ['Raio Arcano', 'Explosão de Ruína', 'Barreira Mística', 'Dreno de Mana'],
        disadvantages: ['Pouca defesa física'],
        bonus: { forca: 0, defesa: 3, agilidade: 0, vida: 0 },
        manaMult: 1.3,
        color: 0x8b5cf6,
        basicAttack: { id: 'raio_basico', name: 'Faísca Arcana', emoji: '✨', type: 'magic', power: 1.15, mana: 0 },
        classGear: { arma: 'cajado_arcano', armadura: null, acessorio: 'orbe_mana' }
    },
    cacador_sombras: {
        id: 'cacador_sombras',
        ...
        rarity: 'comum',
        rarityName: 'Comum',
        desc: 'Atirador ágil que ataca à distância e some nas sombras.',
        activeAbilities: ['Tiro Preciso', 'Chuva de Flechas', 'Passo Sombrio', 'Armadilha'],
        passives: ['Olho de Águia', 'Pés Leves'],
        powers: ['Tiro Preciso', 'Chuva de Flechas', 'Passo Sombrio', 'Armadilha'],
        disadvantages: ['Frágil em combate próximo'],
        ...
        classGear: { arma: 'arco_longo', armadura: null, acessorio: 'botas_vento' }
    },
    guardiao_runico: {
        id: 'guardiao_runico',
        ...
        rarity: 'incomum',
        rarityName: 'Incomum',
        desc: 'Tanque protegido por runas. Aguenta o front e protege aliados.',
        activeAbilities: ['Escudo Rúnico', 'Provocar', 'Muralha', 'Contra-golpe'],
        passives: ['Pele de Pedra', 'Presença Protetora'],
        powers: ['Escudo Rúnico', 'Provocar', 'Muralha', 'Contra-golpe'],
        disadvantages: ['Dano baixo'],
        bonus: { forca: 1, defesa: 0, agilidade: 0, vida: 3 },
        manaMult: 0.95,
        color: 0x3b82f6,
        basicAttack: { id: 'pancada', name: 'Pancada de Escudo', emoji: '🛡️', type: 'physical', power: 0.95, mana: 0 },
        classGear: { arma: 'escudo_ferro', armadura: 'armadura_pesada', acessorio: 'elmo_guerra' }
    },
    oraculo_vital: {
        id: 'oraculo_vital',
        name: 'Oráculo Vital',
        ...
        rarity: 'incomum',
        rarityName: 'Incomum',
        desc: 'Suporte que cura e fortalece o grupo com magia vital.',
        activeAbilities: ['Cura Menor', 'Bênção', 'Purificar', 'Renovação'],
        passives: ['Toque Curativo', 'Aura Serena'],
        powers: ['Cura Menor', 'Bênção', 'Purificar', 'Renovação'],
        disadvantages: ['Dano ofensivo baixo'],
        bonus: { forca: 0, defesa: 2, agilidade: 1, vida: 1 },
        manaMult: 1.2,
        color: 0x34d399,
        basicAttack: { id: 'toque_luz', name: 'Toque de Luz', emoji: '💚', type: 'magic', power: 0.9, mana: 0 },
        classGear: { arma: 'cajado_luz', armadura: null, acessorio: 'amuleto_vida' }
    },
    l_detetive_arcano: {
