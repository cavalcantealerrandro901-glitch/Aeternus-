...
module.exports = {
    ...
    async run(userId, guildId, amount, side) {
        ...
        const note = await aiGameResult(win, 'coinflip', amount);

        return { result, win, amount, total: user.almas, note };
    },
    ...
    async execute(interaction) {
        ...
        const embed = new EmbedBuilder()
            ...
            .setDescription(
                ...
                (r.win
                    ? `Lucro: ${formatAlmas(r.amount, interaction.guild.id)}`
    ...
    async executePrefix(message, args) {
        ...
        const embed = new EmbedBuilder()
            ...
            .setDescription(
                ...
                `Escolha: **${side}** · Resultado: **${r.result}**\n` +
                (r.win
                    ? `Lucro: ${formatAlmas(r.amount, message.guild.id)}`
