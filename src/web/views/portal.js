...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Plus Jakarta Sans', sans-serif; }
        ...
        .sidebar { width: 80px; background: #030712; border-right: 1px solid rgba(255,255,255,0.05); display: flex; flex-direction: column; align-items: center; padding: 20px 0; gap: 16px; }
        .sidebar-guild { width: 48px; height: 48px; border-radius: 16px; overflow: hidden; transition: all 0.2s; border: 2px solid transparent; opacity: 0.7; }
        ...
        .form-control { background: rgba(0,0,0,0.4); border: 1px solid rgba(255,255,255,0.1); padding: 12px 16px; border-radius: 10px; color: #fff; font-size: 0.95rem; outline: none; }
        .form-control:focus { border-color: #38bdf8; }

        .btn-save { background: linear-gradient(135deg, #38bdf8, #2563eb); color: #fff; border: none; padding: 12px 24px; border-radius: 12px; font-weight: 700; cursor: pointer; transition: all 0.2s; }
...
<body>
    <div class="sidebar">
        ...
        <hr style="width: 30px; border: 0; border-top: 1px solid rgba(255,255,255,0.1); margin: 8px 0;">
        ${guildList}
    </div>
    ...
    <div class="main-content">
        <div class="header">
            <div class="guild-title">
                ...
                <div>
                    <h1 style="font-size: 1.8rem; font-weight: 800;">${guild.name}</h1>
                    <p style="color: #94a3b8; font-size: 0.9rem;">ID: ${guild.id}</p>
                </div>
            </div>
            <a href="/dashboard" style="color: #94a3b8; text-decoration: none; font-size: 0.9rem; border: 1px solid rgba(255,255,255,0.1); padding: 8px 16px; border-radius: 10px;">← Voltar</a>
        </div>
